          ...
          <div className="flex flex-1 min-w-0 items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center">
                ...
                ></span>
                <h3 className="text-sm font-medium truncate">{user.nombre || user.usuario}</h3>
              </div>
              <p className="text-xs text-muted-foreground truncate">{user.email}</p>
              <p className="text-xs mt-1 truncate">Tel: {user.telefono || "Sin teléfono"}</p>
              <p className="text-xs truncate">Ciudad: {user.ciudad || "Sin ciudad"}</p>
              <p className="text-xs truncate">Dirección: {user.direccion || "Sin dirección"}</p>
